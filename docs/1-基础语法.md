...
-   [PetShop.Main | CS 61B Spring 2021](https://sp21.datastructur.es/index.html) (很推荐各位在大一的时候多去刷刷公开课，拿 61b 来说，61b 使用 java 语言教学数据结构，他的前几轮 disc 是对 java 的 intro，很适合初学者入门)
...
**1. 一个 PetShop.model.Animal 动物类 (抽象类 abstract )**
...
**2. 中华田园犬类** (extends PetShop.model.Animal)<img src="https://gitee.com/sky-dog/note/raw/master/img/202210252201019.jpg" alt="img" style="zoom:3%;" />

-   变量: isVaccineInjected(boolean 是否注射狂犬病疫苗)
-   价格 100 元

**3. 猫猫类 (extends PetShop.model.Animal)**<img src="https://gitee.com/sky-dog/note/raw/master/img/202210252202619.png" alt="image-20221025220229577" style="zoom:15%;" />
